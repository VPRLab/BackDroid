...
if [ $1 ] && [ $2 ]
then
time timeout 61m java -Xmx4g -Xss100m -cp ../BackDroid/bin:$sootJar:../lib/commons-cli-1.2.jar:$infoflow:$otherJar:$mainSDK:$mainGAPI:$mainClass:$otherSDK:$otherClass edu.smu.backdroid.PortDetector -a $1 -p $2
# $1: -a, the apk prefix name
