...
if [ $1 ] && [ $2 ] && [ $3 ]
then
time timeout 61m java -Xmx4g -Xss100m -cp ../NewDroid/bin:$sootJar:../lib/commons-cli-1.2.jar:$infoflow:$otherJar:$mainSDK:$mainGAPI:$mainClass:$otherSDK:$otherClass edu.smu.backdroid.PortDetector -a $1 -r $2 -t $3
elif [ $1 ] && [ $2 ]
then
time timeout 61m java -Xmx4g -Xss100m -cp ../NewDroid/bin:$sootJar:../lib/commons-cli-1.2.jar:$infoflow:$otherJar:$mainSDK:$mainGAPI:$mainClass:$otherSDK:$otherClass edu.smu.backdroid.PortDetector -a $1 -r $2
# backDroid/test$ ../bin/rawdroid.sh com.samremote.view-16
else
time timeout 61m java -Xmx4g -Xss100m -cp ../NewDroid/bin:$sootJar:../lib/commons-cli-1.2.jar:$infoflow:$otherJar:$mainSDK:$mainGAPI:$mainClass:$otherSDK:$otherClass edu.smu.backdroid.PortDetector -a $1
fi
